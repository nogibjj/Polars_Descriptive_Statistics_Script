...
def get_summary_stats(dataset, col_of_intrst):
    ...
    print("Mean final exam score is " + str(round(mean, 3)) + " points")
    print("Median final exam score is " + str(round(median, 3)) + " points")
    print(
...
if __name__ == "__main__":
    # read the csv
    student_data = readcsv("StudentPerformance.csv")
